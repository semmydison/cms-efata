    ...
    <table class="table-data">
        <thead>
            <tr>
                ...
                <th width="25%">Uraian Pengeluaran</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="nowrap font-bold">
                    ...
                    <span class="rp-amount">{{ number_format($row['pengeluaran'], 0, ',', '.') }}</span>
                </td>
            </tr>
            @empty
            <tr>
        ...
        <tfoot>
            <tr style="background-color: #e0e0e0;">
                <td colspan="7" class="text-right font-bold uppercase">Total Pengeluaran Keseluruhan</td>
                <td class="text-right font-bold nowrap">
                    <span class="rp-symbol">Rp</span> 
                    <span class="rp-amount">{{ number_format($totalPengeluaran, 0, ',', '.') }}</span>
                </td>
            </tr>
        </tfoot>
    </table>
